...
const QMetaObject ListViewTest::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ListViewTest.data,
      qt_meta_data_ListViewTest,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ListViewTest::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ListViewTest.stringdata0))
        return static_cast<void*>(const_cast< ListViewTest*>(this));
